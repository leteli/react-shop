import type { RootState } from '../../src/index';
import { ICartProductData, IProductData } from '../interfaces/interfaces';
...
export const cartProduct: ICartProductData = {
  id: 10,
  name: "Прыжки на месте. Короткая проза",
  price: 600,
  quantity: 2,
...
export const cartWithThreeProducts = [
  cartProduct1,
  cartProduct2Two,
];

export const cartWithSixProducts = [
  cartProduct1Four,
  cartProduct2Two,
];
